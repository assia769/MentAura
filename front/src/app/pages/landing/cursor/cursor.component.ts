...
@Component({
  ...
  styles: [`
    ...
    .cursor-ring {
      ...
      transform: translate(-50%, -50%);
      transition: left .12s cubic-bezier(.22,1,.36,1), top .12s cubic-bezier(.22,1,.36,1), transform .3s;
    ...
    .ring-arc {
      fill: none; stroke: url(#goldGrad); stroke-width: 1.8px;
    ...
    .cursor-dot {
      ...
      &.hovered { transform: scale(0); opacity: 0; }
    }
  `]
})
